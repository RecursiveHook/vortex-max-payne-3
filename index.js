// Nexus Mods domain for the game. e.g. nexusmods.com/maxpayne3
const GAME_ID = "maxpayne3";

//Steam Application ID, you can get this from https://steamdb.info/apps/
const STEAMAPP_ID = "204100";
...
const spec = {
    game: {
        ...
        logo: "max_payne_3.jpg",
        modFileExt: ".zip",
        mergeMods: true,
        modPath: ".",
        modPathIsRelative: true,
        requiredFiles: ["MaxPayne3.exe"],
        details: {
            steamAppId: 204100,
            nexusPageId: "maxpayne3",
            stopPatterns: ["(^|/)Max Payne 3(/|$)"],
        },
        environment: {
            SteamAPPId: "204100",
        },
...
const tools = [
    ...
    It has both a game launcher and the R* launcher... :facepalm:
    Game Launcher: PlayMaxPayne3.exe
    R* Launcher:
...
function pathPattern(api, game, pattern) {
    ...
    return template(pattern, {
        gamePath:
            (_a = api.getState().settings.gameMode.discovered[game.id]) === null || _a === void 0 ? void 0 : _a.path,
...
function makeRequiresLauncher(api, gameSpec) {
    return () =>
        Promise.resolve(
            gameSpec.game.requiresLauncher !== undefined ? { launcher: gameSpec.game.requiresLauncher } : undefined
        );
}
...
function applyGame(context, gameSpec) {
        ...
        context.registerModType(
            ...
            (gameId) => {
                ...
                return (
                    ...
                    !!((_a = context.api.getState().settings.gameMode.discovered[gameId]) === null || _a === void 0
                        ? void 0
                        : _a.path)
                );
            },
    ...
    // context.registerInstaller("maxpayne3-mod", 25, testSupportedContent, installContent);
}
